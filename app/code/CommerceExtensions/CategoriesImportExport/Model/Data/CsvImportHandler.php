...
//   leave this for the end in case we have any issues
        ...
        setcookie($cookiename, "0 (Finished!)", time() - 12000, "/");
        if (($ttlnumrectogo - $recnum) <= 0 || $max_categories <= 1) {
            ...
            setcookie($cookiename2, '', time() - 12000, "/");
        } else {
            setcookie($cookiename, $max_categories, time() + 60, "/");
            ...
            setcookie($cookiename2, $ourmessage, time() + 60, "/");
        }
        //die("no error yet");
    }
