...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init('MageWorx\SeoRedirects\Model\Redirect\DpRedirect', 'MageWorx\SeoRedirects\Model\ResourceModel\Redirect\DpRedirect');
    }
    ...
    {
        $this->getSelect()->where('main_table.status = ?', \MageWorx\SeoRedirects\Model\Redirect\DpRedirect::STATUS_ENABLED);
        return $this;
    }
