 ...
 */
 class Product extends \MageWorx\SeoXTemplates\Model\ResourceModel\Template
{
     /**
      *
      * @var string
    ...
    {
        $id = $template->getId();
        $attributesetId = $template->getAttributeset();
    ...
    /**
     * Retrive individual item ids by template(s)
     *
    ...
    /**
     * Retrive group item ids by template(s)
     *
