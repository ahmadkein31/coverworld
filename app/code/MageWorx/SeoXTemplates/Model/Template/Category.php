...
class Category extends \MageWorx\SeoXTemplates\Model\AbstractTemplate
{
    ...
    /**
     * Retrive type title such as "Category Meta Title", "Category SEO Name", ... by type ID
     *
    ...
    public function afterSave()
    {
        ...
        elseif ($this->getId() && $this->isAssignForIndividualItems()) {
            ...
            if ($oldAssignType == $newAssignType) {
                ...
                $oldItemIds    = $this->getOrigData('categories_data') ? $this->getOrigData('ategories_data') : [];
