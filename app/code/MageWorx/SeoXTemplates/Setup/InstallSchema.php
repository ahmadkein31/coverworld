    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $tableTemplateProduct = $installer->getConnection()->newTable(
            $installer->getTable('mageworx_seoxtemplates_template_product')
                ...
                'template_id', \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER, null,
                [
                'identity' => true,
                'unsigned' => true,
                'nullable' => false,
            ...
            ) ->addColumn('type_id', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Template Type')
            ...
            ->addColumn('code', Table::TYPE_TEXT, '64k', array(
                'nullable'  => false,
                ), 'Template Code')

            ->addColumn('assign_type', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Assign Type')

            ->addColumn('priority', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Priority')

            ->addColumn('date_modified', Table::TYPE_DATETIME, null, array(
                'nullable'  => true,
                ), 'Last Modify Date')

            ->addColumn('date_apply_start', Table::TYPE_DATETIME, null, array(
                'nullable'  => true,
                ), 'Last Apply Start Date')

            ->addColumn('date_apply_finish', Table::TYPE_DATETIME, null, array(
                'nullable'  => true,
                ), 'Last Apply Finish Date')

            ->addColumn('scope', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                'default'  => 1,
                ), 'Scope')

            ->addColumn('is_use_cron', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                'default'  => 2,
                ), 'Is Use Cron')
        ...
        $tableTemplateProductRelation = $installer->getConnection()->newTable(
            ...
            ->addColumn('template_id', Table::TYPE_INTEGER, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Template ID')

            ->addColumn('product_id', Table::TYPE_INTEGER, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Product ID')
        ...
        $tableTemplateProductAttributeRelation = $installer->getConnection()->newTable(
            ...
            ->addColumn('attributeset_id', Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                ), 'Attribute Set ID')
