...
class View extends \Magento\Catalog\Block\Category\View {
    ...
    // removed by Ralph to resolve compiler error
    // \Magento\Store\Model\StoreManagerInterface $storeManager, 
    public function __construct(
    \Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Framework\Registry $registry, \Magento\Catalog\Helper\Category $categoryHelper, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Magento\Cms\Model\BlockFactory $blockFactory, array $data = []
    ) {
    ...
    public function getInformationTabsHtml() {
        ...
        $html = '';
        if ($blockIdentifier) {
            $storeId = 0; //$this->storeManager->getStore()->getId();
