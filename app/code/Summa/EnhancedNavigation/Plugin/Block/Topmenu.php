...
namespace Summa\EnhancedNavigation\Plugin\Block;
...
class Topmenu
{
    ...
    private function getCategoryAsArray($category, $currentCategory)
    {
        return [
            ...
            'navigation_banner' => $category->getNavigationBanner(),
            'icon_image' => $category->getIconImage()
        ];
    }
    ...
    protected function getCategoryTree($storeId, $rootId)
    {
        ...
        $collection->addAttributeToSelect('navigation_banner');
